    ...
    <el-dialog width="55%" title="代购订单详情" :visible.sync="dialogEdit" :close-on-click-modal="false">
      ...
      >
        <el-form-item label="代购订单号" prop="exportNo">
          <el-input v-model="addInfo.exportNo" maxlength="40" disabled></el-input>
        </el-form-item>
        <el-form-item label="导出时间" prop="exportTime">
          <el-input v-model="addInfo.exportTime" maxlength="40" disabled></el-input>
        </el-form-item>
        <el-form-item label="京东订单号" prop="jdOrderNo">
          <el-input v-model="addInfo.jdOrderNo"></el-input>
        </el-form-item>
        <el-form-item label="批次号" prop="batchNo">
          <el-input v-model="addInfo.batchNo" disabled></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    addSure(){
      ...
      let params = {
        id: this.addInfo.id,
        jdOrderNo: this.addInfo.jdOrderNo,
        remark: this.addInfo.remark
      };
      this.$axios.post(API.UPDATE_EXPORTORDER_API, params).then(res => {
        this.loading.endLoading();
        if (0 == res.data.code) {
            this.$message({
            showClose: true,
